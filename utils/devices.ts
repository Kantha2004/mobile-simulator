...
// utils/devices.ts - Comprehensive Device Presets for Mobile, Tablets, Laptops & Desktop Monitors

export type DeviceType = 'iphone-island' | 'iphone-notch' | 'iphone-classic' | 'android-punch' | 'tablet' | 'laptop' | 'monitor';
...
export const DEVICE_PRESETS: DevicePreset[] =  [
  ...
  },
  {
    ...
    name: 'Standard Laptop (1366 Ã— 768)',
    category: 'Laptops',
    width: 1366,
    height: 768,
    dpr: 1.0,
